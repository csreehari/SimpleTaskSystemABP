        ...
        public override void SetNavigation(INavigationProviderContext context)
        {
            context.Manager.MainMenu
                .AddItem(
                    ...
                    new MenuItemDefinition(
                        "Holders",
                        new LocalizableString("Holders", SimpleTaskSystemConsts.LocalizationSourceName),
                        url: "#/holders",
                        icon: "fa fa-info"
                        )
                ).AddItem(
                    new MenuItemDefinition(
                        "Seekers",
                        new LocalizableString("Seekers", SimpleTaskSystemConsts.LocalizationSourceName),
                        url: "#/seekers",
                        icon: "fa fa-info"
                        )
                );
